...
class ObservationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create observation" do
    assert_difference("Observation.count") do
      post observations_url, params: { observation: { name: @observation.name, observed: @observation.observed } }
    end
  ...
  test "should update observation" do
    patch observation_url(@observation), params: { observation: { name: @observation.name, observed: @observation.observed } }
